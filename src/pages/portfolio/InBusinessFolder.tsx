...
/**
 * InBusinessFolder Page - Displays sub-folders like Project, Process, Block for a selected business.
 */
...
const FolderIcon = () => (
  <svg
    ...
    viewBox="0 0 24 24"
    fill="currentColor"
    className="text-blue-500 opacity-80 group-hover:scale-110 transition-transform duration-300"
  >
    <path d="M10 4H4c-1.11 0-2 .89-2 2v12c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2h-8l-2-2z" />
  </svg>
);

const InBusinessFolder = () => {
  ...
  const currentCrumbs = [
    ...
    { label: "Folder", to: "/dashboard/portfolio/saas/folder" },
  ];
  ...
  return (
    <PageLayout>
      ...
      <div className="flex items-center justify-center gap-8 mb-8">
        {["Folders", "Files"].map((tab) => (
          <motion.button
            key={tab}
            onClick={() => setActiveTab(tab)}
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className={`relative px-2 py-1 text-sm font-medium transition-colors cursor-pointer ${activeTab === tab
      ...
      <div className="flex h-[calc(100vh-100px)] items-center justify-center">
        {activeTab === "Folders" && (
          <div className="max-w-7xl w-full px-4">
            <DragDropContext onDragEnd={onDragEnd}>
              <Droppable droppableId="saas-folder-cards" direction="horizontal">
                {(provided) => {
                              ...
                              >
                                ...
                                <div className="absolute top-4 right-4 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity z-10">
                                  <button
                                    ...
                                    className="p-2 rounded-xl bg-white/80 dark:bg-slate-800/80 hover:bg-white dark:hover:bg-slate-700 text-gray-400 dark:text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 transition-all shadow-sm cursor-pointer"
                                  >
                                    <EditIcon />
                                  </button>
                                  <button
                                    ...
                                    className="p-2 rounded-xl bg-white/80 dark:bg-slate-800/80 hover:bg-white dark:hover:bg-slate-700 text-gray-400 dark:text-gray-500 hover:text-red-600 dark:hover:text-red-400 transition-all shadow-sm cursor-pointer"
                                  >
                                    <TrashIcon />
                                  </button>
                                </div>
        ...
        {activeTab === "Files" && (
          <div className="text-gray-500 dark:text-gray-400 text-sm font-['Inter']">
            No files found
          </div>
        )}
      </div>
...
export default InBusinessFolder;
